...
Before a certificate exists, `host-bootstrap.conf.example` may be enabled temporarily for the ACME
challenge and HTTP smoke test. It must be replaced by the HTTPS vhost immediately after issuance.
