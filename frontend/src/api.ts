...
export class ApiClient {
  ...
  telegramSetProxy(payload: { protocol: "SOCKS5" | "HTTP"; host: string; port: number; username?: string; password?: string }) { return this.request<TelegramConnection>("/competitor-intelligence/telegram/connection/proxy", { method: "PUT", body: JSON.stringify(payload) }); }
