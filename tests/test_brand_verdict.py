...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Существует множество способов изучить разработку. Вот несколько предложений:\n"
            "1. **Онлайн-курсы и платформы для обучения:**\n"
            "* **Skillbox** предлагает курсы по разработке.\n"
            "* **GeekBrains** предоставляет курсы программирования.\n"
