...
from notification_center.schemas import NotificationEventCreate, NotificationRead
...
def list_notifications(
    request: Request, db: DbSession, unread_only: bool = False
) -> list[NotificationRead]:
    return build_notification_service(db).list(_user_id(request), unread_only)
