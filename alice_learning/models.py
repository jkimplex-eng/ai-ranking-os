...
class AliceAutomationPlan(Base):
    ...
    weekly_query_limit: Mapped[int] = mapped_column(Integer, nullable=False, default=30)
    ...
    monitoring_frequency: Mapped[str] = mapped_column(String(20), nullable=False, default="DAILY")
