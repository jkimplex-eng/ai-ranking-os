...
def main():
    ...
    with httpx.Client(base_url="http://127.0.0.1:8000", timeout=30) as client:
        ...
        if login.is_success:
            ...
            for path in [
                "/auth/me",
                "/integrations/yandex-wordstat/status",
                "/integrations/yandex-webmaster/status",
                "/yandex-intelligence/dashboard",
                "/alice-learning/dashboard",
                "/alice-learning/automation/dashboard",
            ]:
